...
if (!empty($_SESSION['username'])) {
    ...
    (!$user_id = antiinjection($koneksi, $_POST['id']));
      ...
      $jabatan = antiinjection($koneksi, $_POST['jabatan']);
      $jenis_kelamin = antiinjection($koneksi, $_POST['jeniskelamin']);
      ...
      alamat = '$alamat',
      no_telp = '$no_telp',
      jabatan_id = '$jabatan' WHERE user_id = '$user_id'";
      ...
      if (mysqli_query($koneksi, $query_anggota)) {
        if (empty($_POST['password'])){
            ...
            $uery_user = "UPDATE user SET username = '$username', password = '$hashed_password', salt = '$salt' WHERE id = '$user_id' ";
