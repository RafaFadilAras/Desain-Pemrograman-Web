...
session_start();
    if (!empty($_SESSION['username'])) {
        ...
        if (!empty($_GET['jabatan'])) {
            $jabatan = antiinjection($koneksi, $_POST['jabata']);
        ...
        (!$username = antiinjection($koneksi, $_POST['username']));
          ...
          if (mysqli_query($koneksi, $query)) {
            ...
            $query2 = "INSERT INTO anggota (nama, jenis_kelamin, alamat, no_telp, user_id, jabatan_id) VALUES '$nama', '$jenis_kelamin', '$alamat', '$no_telp', '$last_id', '$jabata')";
            if (mysqli_query($koneksi, $query2)) {
                pesan('succes', "Anggota Baru Ditambahkan");
            } else {
