                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="jabata" name aria-label="Default select example">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-chech-label" for="inlineRadio1">Laki-Laki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" value="P" <?= ($row['jenis_kelamin'] === "P") ? 'checked' : '' ?>> 
                                        <label class="form-chech-label" for="inlineRadio1">Perempuan</label>
                                    </div>
                                </div>
                                <div class="mb-3">
