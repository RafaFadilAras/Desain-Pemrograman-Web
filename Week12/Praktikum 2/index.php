...
<html lang="en">
    ...
    <body>
        ...
        <div class="model fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModelLabel" aria-hidden="true">
            <div class="model-dialog" role="document">
                <div class="model-content">
                    <div class="model-header">
                        <h5 class="model-title" id="exampleModelLabel">
                            Tambah Data Jabatan
                        </h5>
